...
public class QueryTools {
    ...
    public static List<News> fetchNewsData(String url) {
        ...
        try {
            ...
            Log.e(ContentValues.TAG, "Error creating JSON Object from HTTPRequest String", e);
        }catch (IOException e) {
            e.printStackTrace();
            Log.e(ContentValues.TAG, "Error fetching news data", e);
        }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try{
            ...
            e.printStackTrace();
            Log.e(ContentValues.TAG, "Error making HTTP request: ", e);
        }
    ...
    private static URL createUrl(String stringUrl) {
        ...
        try {
            ...
            Log.e(ContentValues.TAG, "Error creating URL", e);
        }
